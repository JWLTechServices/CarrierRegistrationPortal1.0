...
namespace JWLApplication.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(ICarrierProcessingService carrierProcessingService, IWebHostEnvironment hostingEnvironment)
        {
        ...
        public async Task<IActionResult> Create([Bind("name,email,password,confirmPassword,userType,isActive")] users users)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                client.Credentials = new NetworkCredential("deep.soni@credencys.com", "Dhavadi@1");
                client.EnableSsl = true;
                MailMessage message = new MailMessage();
                message.From = new MailAddress("deep.soni@credencys.com");
